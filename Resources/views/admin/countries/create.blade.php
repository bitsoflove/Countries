...
<h1>
    {{ trans('countries::countries.title.create country') }}
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
    <li><a href="{{ route('admin.countries.country.index') }}">{{ trans('countries::countries.title.countries') }}</a></li>
    <li class="active">{{ trans('countries::countries.title.create country') }}</li>
</ol>
@stop
...
@section('content')
{!! Form::open(['route' => ['admin.countries.country.store'], 'method' => 'post']) !!}
